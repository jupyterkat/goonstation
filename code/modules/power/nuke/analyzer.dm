...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="[config.cdn]/css/bootstrap.min.css?serverrev=[vcs_revision]" />
    <link rel="stylesheet" type="text/css" href="[config.cdn]/css/bootstrap-responsive.min.css?serverrev=[vcs_revision]" />
    <script type="text/javascript" src="[config.cdn]/js/jquery.min.js?serverrev=[vcs_revision]"></script>
    <script type="text/javascript" src="[config.cdn]/js/jquery.migrate.js?serverrev=[vcs_revision]"></script>
    <style type="text/css">
        body {
...
<body>
    <script type="text/javascript" src="[config.cdn]/js/bootstrap.min.js?serverrev=[vcs_revision]"></script>
    <script type="text/javascript" src="[config.cdn]/js/jsviews.min.js?serverrev=[vcs_revision]"></script>
