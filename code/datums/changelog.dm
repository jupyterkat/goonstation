			...
			switch(copytext(line, 1, 4))
				...
				if("(*)")
					if(!added_author && author)
						...
						if(emoji_labels)
							...
							html += "</span>"
						if(pr_num)
							html += "<a target='_blank' href='https://github.com/austation/goonstation/pull/[pr_num]' class='pr_link'><span class='pr_number'>#[pr_num]</span>&gt;</a>"
						html += "</li>"
						added_author = 1
				...
				if("(+)")
					if(!added_collapsible_author && author)
						...
						if(pr_num)
							collapsible_html += "<a target='_blank' href='https://github.com/austation/goonstation/pull/[pr_num]' class='pr_link'><span class='pr_number'>#[pr_num]</span>&gt;</a>"
						collapsible_html += "</li>"
...
//<img alt="Goonstation 13" src="[resource("images/changelog/postcardsmall.jpg")]" class="postcard" />
	...
	html = {"
<h1>AusGoon <a href="#license"><img alt="Creative Commons CC-BY-NC-SA License" src="[resource("images/changelog/88x31.png")]" /></a></h1>

<ul class="links cf">
    <li>Official Wiki<br><strong><a target="_blank" href="[config.wiki_url]/">[config.wiki_url]</a></strong><span></span></li>
    <li>Official Forums<br><strong><a target="_blank" href="[config.forums_url]">[config.forums_url]</a></strong></li>
</ul>"}
