...
/world/proc/load_playercap_bypass()
	set background = 1
	var/text = file2text("config/allow_thru_cap.txt")
	if (!text)
		return
	else
		var/list/lines = splittext(text, "\n")
...
/world/proc/update_status()
	...
	if (config?.server_name)
		s += "<b><a href=\"https://austation.net\">[config.server_name]</a></b> &#8212; "
	else
		s += "<b>SERVER NAME HERE</b> &#8212; "

	s += "The classic SS13 experience. &#8212; (<a href=\"http://bit.ly/ZTGQAqB\">Discord</a>)<br>"
